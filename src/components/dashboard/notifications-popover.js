...
const notifications = [
  {
    id: '1',
    content:
      'Sit occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim.',
...
export const NotificationsPopover = (props) => {
  ...
  return (
    <>
      <Badge color="success" variant="dot" {...props}>
        <IconButton
          onClick={handleOpen}
          ref={anchorRef}
          sx={{
      ...
      >
        <List>
          <ListSubheader sx={{ py: 1 }}>Notifications</ListSubheader>
