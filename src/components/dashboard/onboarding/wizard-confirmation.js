    ...
    <div>
      ...
      <Card>
        <PropertyList>
          ...
          />
          <PropertyListItem divider label="Full Name" value={values.fullName} />
          <PropertyListItem divider label="Website" value={values.website} />
          <PropertyListItem
            divider
            label="Company Name"
          ...
          <PropertyListItem
            ...
            value={Object.entries(values.notifications)
              .filter(([, value]) => value)
              .map(
                ([key]) =>
                  notificationOptions.find((option) => option.name === key)
                    .label,
              )
              .join(', ')}
          />
