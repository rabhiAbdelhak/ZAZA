...
const businessOptions = [
  ...
  {
    content:
      'Platform as a service (PaaS) is a deployment environment in the cloud, with resources that enable you to deliver cloud-based apps or even enterprise apps.',
  ...
  return (
    <div>
      <form onSubmit={handleSubmit}>
        ...
        >
          <Typography color="textPrimary" sx={{ mb: 0.5 }} variant="h6">
            Step 1. Business type
          </Typography>
          <Typography color="textSecondary" variant="body2">
            Our architecture is ready for any type of business, just let us know
