...
const customerNotes = [
  {
    id: '1',
    content:
      'I really enjoyed working with this client! She is a ray of sunshine every time I call her. She has a cat called Sticks which she loves very much',
  ...
  },
  {
    id: '2',
    content:
      'Don’t call the client before 5 PM, trust me I know what I’m saying',
...
class CustomerApi {
  async getCustomers(options) {
    ...
    const queriedCustomers = customers.filter((_customer) => {
      ...
      if (
        !!query &&
        !_customer.fullName?.toLowerCase().includes(query.toLowerCase())
      ) {
        return false
      }
